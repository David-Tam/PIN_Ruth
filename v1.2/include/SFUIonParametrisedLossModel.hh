...
#ifndef SFUIONPARAMETRISEDLOSSMODEL_HH
#define SFUIONPARAMETRISEDLOSSMODEL_HH
...
class SFUIonParametrisedLossModel : public G4VEmModel {

 public:
   SFUIonParametrisedLossModel(const G4ParticleDefinition* particle = 0,
                              const G4String& name = "ParamICRU73");

   virtual ~SFUIonParametrisedLossModel();
 ...
 private:
   ...
   SFUIonParametrisedLossModel & operator=(
                              const SFUIonParametrisedLossModel &right);
   SFUIonParametrisedLossModel(const SFUIonParametrisedLossModel &);
...
#include "SFUIonParametrisedLossModel.icc"
